...
public class RegistrationPage {
	...
	@FindBy(xpath = "//input[@name='Gender*' and @id='ion-input-9']")
	...
	public void select_Gender(String gender) throws InterruptedException {
		...
		Thread.sleep(2000);
		 gm.SwichToFramforTab(driver);
		WebElement gender_male = 
		driver.findElement(By.xpath(String.format("//input[@name='Gender*']//following::div//ion-item[normalize-space()='%s']", gender)));
				...
				while (attempts < 3) {
					try {
						...
						WebElement dropdownElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
								String.format("//input[@name='Gender*']//following::div//ion-item[normalize-space()='%s']", gender))));
...
//        Thread.sleep(2000);
	...
	public void lastName() throws InterruptedException {
		Random random = new Random();
		int nameLength = 6; // you can set the name length you want
...
//		aadharNo.clear();
//		aadharNo.sendKeys("112234567891");
//		System.out.println("AdharNo add successfully");
//		Thread.sleep(2000);
